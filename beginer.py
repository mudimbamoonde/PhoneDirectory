# USAGE
# python pi_detect_drowsiness.py --cascade haar cascade_frontal face_default.xml --shape-predict or shape_predictor_68_face_landmarks.dat
# python pi_detect_drowsiness.py --cascade haar cascade_frontal face_default.xml --shape-predict or shape_predictor_68_face_landmarks.dat --alarm 1
...
def euclidean_dist(ptA, ptB):
    ...
    if args["alarm"] > 0:
        ...
        print("[INFO] loading facial landmark predictor from " + str(args["cascade"]))
